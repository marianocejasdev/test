    ...
    return (
        ...
        <div className="container flex flex-col gap-12 justify-center md:grid grid-rows-2 grid-cols-2 grid-flow-row md:gap-8 md:items-start">
            ...
            <div className="flex items-center justify-center row-span-2">
                <img src="./diploma.png" alt="" className='sm:w-8/12 md:w-11/12' />
            </div>

            <div className="flex flex-col justify-center gap-12 md:gap-6 md:row-span-1">

                <h2 className='text-white text-3xl font-semibold border-b-4 border-purple-500 pb-2 self-start'>Skills.</h2>

                <div className='grid grid-cols-4 items-center justify-items-center gap-8 md:grid-cols-6'>
